...
def index():
    if current_user.is_authenticated:
        ...
        return redirect(url_for('main.room_dashboard')) # Updated url_for to include blueprint
    return redirect(url_for('main.login')) # Updated url_for to include blueprint
